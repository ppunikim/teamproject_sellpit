...
<html lang="ko">
  <head>
    ...
    <title>1.랫 풀다운</title>
    <link rel="stylesheet" href="..${rootPath}/static/css/dayHealth.css" />
    <style>
    ...
    <script type="text/javascript">
        ...
        const button_click = (e) =>{
            window.open("../timer/timer.html", "타이머", "width=500px,height=550px")
    ...
    <div id="wrap">
      <header>
        <div>
            ...
            <label class="guidecheck" for="guide"><div class="blankbutton">운동 가이드</div></label>
            <div class="check1">
                <h4>운동 설명 </h4><br />랫 풀다운은 등근육 운동에서도 초급자가 하기 좋은
                운동이에요.<br />
                초급자가 처음에 도전하기 좋고 탄탄함을 높여주기 괜찮은 운동이라서
                등운동이 처음인분들에게는 랫풀다운을 추천드려요.
                <br /><br />
                <h4>운동 가이드 </h4> <br />
                1. 어깨너비보다 조금 넓게 바를 잡아주세요.<br />
                2. 팔꿈치가 뒤로 빠지는 것이 아니라 바닥을 찍는다는 생각 으로 바를
                당겨주세요.<br />
                3. 당기는 위치는 배 쪽이 아닌 쇄골 쪽으로 당겨주세요.<br />
                4. 어깨와 팔을 완전하게 펴면 어깨에 무리가 갈수 있으니
                주의해주세요.<br />
                <br />
               <h4> 호흡법 </h4><br />
                1. 힘을 뺀 후 숨을 들이마십니다.<br />
                2. 내려온 최고 정점에서 호흡을 뱉고 다시 , 흡입한 상태에 서 올라갔다가
                내쉬고를 반복합니다.
            </div>
        </header>
        <section>
            <div>
                <img src="../assets/image/dayHealth/LETPULLDOWN.png">
            </div>
        </section>
        <section>
            <div>
                <div><h4>** 세트가 끝날 때마다 체크를 눌러주세요. **</h4></div>
